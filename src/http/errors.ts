...
export enum HttpErrorCode {
  ...
  InterviewQuizGenerationTimeout = 'interview_quiz_generation_timeout',
...
export const HttpErrorMessages = {
  ...
  [HttpErrorCode.InterviewQuizGenerationTimeout]: 'The interview quiz generation timed out. Please try again.',
