...
export enum InterviewQuizErrorCode {
  ...
  QuestionBankReadFailed = 'question_bank_read_failed',
  QuestionBankSaveFailed = 'question_bank_save_failed',
  LearningMemoryLoadFailed = 'learning_memory_load_failed',
  LearningMemorySaveFailed = 'learning_memory_save_failed',
  JdNotFound = 'jd_not_found',
  JdContextLoadFailed = 'jd_context_load_failed',
  MemoryAttemptInvalid = 'memory_attempt_invalid',
  ...
  SimilarJdSearchLimit = 'quiz_similar_jd_search_limit',
...
export const InterviewQuizErrorMessages = {
  ...
  [InterviewQuizErrorCode.QuestionBankReadFailed]: '读取历史题目失败',
  [InterviewQuizErrorCode.QuestionBankSaveFailed]: '保存本轮题目失败',
  [InterviewQuizErrorCode.LearningMemoryLoadFailed]: '读取长期学习记忆失败',
  [InterviewQuizErrorCode.LearningMemorySaveFailed]: '保存长期学习记忆失败',
  [InterviewQuizErrorCode.JdNotFound]: '当前学习者的 JD 不存在',
  [InterviewQuizErrorCode.JdContextLoadFailed]: '读取 JD 上下文失败',
  [InterviewQuizErrorCode.MemoryAttemptInvalid]: '本轮作答无法转换为长期学习记忆',
  ...
  [InterviewQuizErrorCode.SimilarJdSearchLimit]: '相近市场 JD 搜索超过允许次数。',
